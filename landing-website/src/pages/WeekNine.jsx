...
import p1 from '../components/w91.png';
import p2 from '../components/w92.png';
import p3 from '../components/w93.png';
...
export default function WeekEight({ setCurrentPage }) {
    const leftImages = [p1,null, p2,null];
    const rightImages = [ p2];
