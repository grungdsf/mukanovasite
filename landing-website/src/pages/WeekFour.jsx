...
import photo1 from '../components/w3p1.jpg';
import photo2 from '../components/w3p2.jpg';
import photo3 from '../components/w3p3.png';
import photo4 from '../components/w3p4.jpg';
import photo5 from '../components/w3p5.jpg';

import { Menu } from "../App.js";



export default function WeekFour({ setCurrentPage }) {
    const leftImages = [photo1,null, photo3];
    const rightImages = [photo2, null, photo4,null, photo5];
        ...
        >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'flex-start' }}>
                <h1 style={{ fontSize: "64px", fontWeight: 700, marginBottom: "30px" }}>
                    WEEKLY ACTIVITIES \ WEEK 04

                </h1>
                <p style={{ fontSize: "18px", lineHeight: 1.7, color: "#444", maxWidth: "380px" }}>
                   Link: https://astanait-my.sharepoint.com/:w:/g/personal/251866_astanait_edu_kz/
                    EeISgYkaYS9Lp9c0g2ScZhIB8tUAKAdjqIdAz76wOYvhAw?e=0NeHq3
                </p>
            </div>
            {/* Центральная колонка */}
            <div style={{
