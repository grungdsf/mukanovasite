...
import photo1 from '../components/w51.png';
import photo2 from '../components/w52.png';
import photo3 from '../components/w53.png';

import { Menu } from "../App.js";



export default function WeekFive({ setCurrentPage }) {
    const leftImages = [photo1,null, photo3];
    const rightImages = [photo2, null];
