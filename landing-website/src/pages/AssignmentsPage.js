                                ...
                                if (currentIdx === 0) {
                                    FolderComponent = (
                                        <span
                                            ...
                                            onClick={() => {
                                                window.open("https://docs.google.com/document/d/1KKqlB4UuHy7sANK_CbpW9M24XRzdtf1PbPyVISlno2I/edit?tab=t.0", "_blank");
                                            }}
                                        >
                                            {FolderComponent}
                                        </span>
                                ...
                                // заменяете обработчик на:
                                    ...
                                    FolderComponent = (
                                        <span
                                            ...
                                            onClick={() => {
                                                window.open("https://drive.google.com/file/d/1wBjdTJU8M3cMCw_V99sOSFxo33xYTEEV/view", "_blank");
                                                setTimeout(() => {
                                                    window.open("https://docs.google.com/document/d/1yXoHDX8W9yycUbWl0wgOFojwyfIsIyC9N40DR_SnkGY/edit?tab=t.0", "_blank");
                                                }, 500);
                                            }}
                                        >
      {FolderComponent}
                                    ...
                                    FolderComponent = (
                                        <span
                                            ...
                                            onClick={() => {
                                                window.open("https://docs.google.com/document/d/10G-9-GtMv3ePCLRCOzg7MHFlm9CHUvyHao0Gbkn1t9U/edit?tab=t.0", "_blank");
                                            }}
                                        >
      {FolderComponent}
    </span>
                                    ...
                                    FolderComponent = (
                                        <span
                                            ...
                                            onClick={() => {
                                                window.open("https://drive.google.com/file/d/1TjFqhU3uKh8kjahFn56x0ru7PJ1qt1BG/view", "_blank");
                                            }}                                        >
      {FolderComponent}
    </span>
                                    );
